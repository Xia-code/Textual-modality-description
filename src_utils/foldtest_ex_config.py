...
config_arguments.add_argument('-train_percent', '--train_percent', type=float, required=False, default=0.8, help='train/valid split percent')
...
config_arguments.add_argument('-ex_name', '--ex_name', type=str, required=False, default='IEMOCAP', help='experiment name')
